        ...
        <div className="flex-1 p-5 overflow-auto bg-gray-50">
            ...
            <section className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-white border-t-4 border-blue-500 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                        <h3 className="text-lg font-semibold text-gray-600">Total Weight Lifted</h3>
                        <p className="text-3xl font-bold text-blue-600 mt-2">12,540 kg</p>
                        <div className="w-full h-1 bg-blue-100 mt-3">
                            <div className="h-1 bg-blue-500 w-3/4 animate-pulse"></div>
                        </div>
                    </div>
                    <div className="bg-white border-t-4 border-purple-500 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <div className="w-full h-1 bg-purple-100 mt-3">
                            <div className="h-1 bg-purple-500 w-2/3 animate-pulse"></div>
                        </div>
                    </div>
                    <div className="bg-white border-t-4 border-green-500 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                        <h3 className="text-lg font-semibold text-gray-600">Exercises Done</h3>
                        <p className="text-3xl font-bold text-green-600 mt-2">156</p>
                        <div className="w-full h-1 bg-green-100 mt-3">
                            <div className="h-1 bg-green-500 w-4/5 animate-pulse"></div>
                        </div>
                    </div>
                    <div className="bg-white border-t-4 border-amber-500 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                        <h3 className="text-lg font-semibold text-gray-600">Personal Records</h3>
                        <p className="text-3xl font-bold text-amber-600 mt-2">18</p>
                        <div className="w-full h-1 bg-amber-100 mt-3">
            ...
            <section>
                <h2 className="text-2xl font-bold mb-4">Most Used Exercises</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500 transition-transform duration-300 hover:scale-105">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-purple-500 transition-transform duration-300 hover:scale-105">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-4 border-l-4 border-green-500 transition-transform duration-300 hover:scale-105">
